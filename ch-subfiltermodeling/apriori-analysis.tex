...
In the following subsections, the filtered moment source terms for oxidation and surface growth will be evaluated with the soot subfilter PDFs of \cref{sec:subfilter:zussp,sec:subfilter:zassp}. The form of the source term for oxidation with the $Z$-uniform soot subfilter PDF is given by
