...
\begin{equation}\label{eq:subfilter:zassp:ox}
  \begin{split}
    \mean{\dot{M}}_{x,y}^{ox} &= \iint k_{ox}(Z)\mc{M}_j\pz P(\mc{M}_j|Z) dZ d\mc{M}_j \\
