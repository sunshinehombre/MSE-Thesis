...
On the other hand, it was also observed that the detailed transport model had a less significant influence on predictions of the temperature and the mass fractions of species that participate in the heat-releasing chemistry. In \cref{fig:transport:overview:lei:tvsz}, there is very little difference between the profiles for temperature and hydroxyl mass fraction for the two simulations. The discrepancy between the transport models is larger for the hydrogen mass fraction profile, although this may be the result of an insufficiently high enough Reynolds number. Flamelet solutions with the unity Lewis number approach, indicated by the solid black lines, track the unity Lewis number profiles from the DNS fairly well unlike the solutions with detailed transport, which even deviate from the DNS with the corresponding model. Thus, it is clear that there is a simultaneous presence of molecular diffusion and transport with equal effective diffusivities. A model for gas-phase species transport that accounts for this duality is presented in the upcoming subsection.
