...
The overall objective of this thesis is to better understand how interactions between soot, chemistry, and turbulence as well as the transport of species affect the evolution of soot.

In this portion, make sure to define what soot is and its various modes of evolution.


\input{ch-intro/framework}
\input{ch-intro/scti}
